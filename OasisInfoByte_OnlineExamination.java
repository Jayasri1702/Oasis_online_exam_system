...
public class OasisInfoByte_OnlineExamination {
    HashMap<String, String> d = new HashMap<>();
    Scanner input = new Scanner(System.in);
    /*
    Developed by Jaya Sri S - Oasis InfoByte Java Programming Internship
    */
    ...
    public static void main(String args[]) {
        OasisInfoByte_OnlineExamination e = new OasisInfoByte_OnlineExamination();
        e.login();
    }
}